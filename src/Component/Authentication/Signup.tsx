...
import img4 from '../../assets/Images/LoginImg/signup4.png';
...
const Signup = () => {
  ...
  <div className='flex-1 ml-2'>
    ...
    />
          ...
          <p className='text-white text-center mt-2'> <a href='/login' className='underline' >Already have an account?</a></p>
        </div>
        <div className='grid grid-cols-2 grid-rows-2 gap-3 w-1/2 mt-12 mb-9'>
          <div className='row-span-2'>
          <img src={img1} alt='Image 1' className='rounded-lg hover:-translate-y-2 transition-all duration-500 h-full w-full' />    
          </div>
          
          <div className='row-span-1'>
          <img src={img2} alt='Image 1' className='rounded-lg hover:-translate-y-2 transition-all duration-500 h-full w-full' />    
          </div>
          
          <div className='row-span-2'>
          <img src={img3} alt='Image 1' className='rounded-lg hover:-translate-y-2 transition-all duration-500 h-full w-full' />    
          </div>
          
          <div className='row-span-1'>
          <img src={img4} alt='Image 1' className='rounded-lg hover:-translate-y-2 transition-all duration-500 h-full w-full' />    
          </div>
        </div>
      </div>
    </div>
