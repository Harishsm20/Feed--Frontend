  ...
  return (
    <div className='flex justify-center items-center min-h-screen bg-gradient-to-r from-[#333300] to-[#333300]'>
      <div className='flex bg-gradient-to-b from-[#534825] to-[#4f4e4a] rounded-3xl shadow-lg max-w-5xl w-full p-8'>
        <div className='flex flex-col space-y-3 w-1/2 mt-3'>
          <div className='flex space-x-3'>
            <img src={img1} alt='Image 1' className='w-1/2 rounded-lg hover:-translate-y-2 transition-all duration-500 object-cover' />
            <img src={img2} alt='Image 2' className='w-1/2 rounded-lg hover:-translate-y-2 transition-all duration-500 object-cover' />
          </div>
          <div className='flex space-x-3'>
            <img src={img3} alt='Image 3' className='w-1/2 rounded-lg hover:-translate-y-2 transition-all duration-500 object-cover' />
            <img src={img4} alt='Image 4' className='w-1/2 rounded-lg hover:-translate-y-2 transition-all duration-500 object-cover' />
          </div>
        </div>
