    ...
    <div className='flex justify-center items-center min-h-screen bg-gradient-to-r from-[#333300] to-[#333300]'>
      <div className='flex bg-gradient-to-b from-[#534825] to-[#4f4e4a] rounded-3xl shadow-lg max-w-5xl w-full p-8'>
        <div className='grid grid-cols-2 gap-3 size-6/12'>
          <img src={img1} alt='Image 1' className='rounded-lg hover:-translate-y-2 transition-all duration-500' />
          <img src={img2} alt='Image 2' className='rounded-lg hover:-translate-y-2 transition-all duration-500' />
          <img src={img3} alt='Image 3' className='rounded-lg hover:-translate-y-2 transition-all duration-500' />
          <img src={img4} alt='Image 4' className='rounded-lg hover:-translate-y-2 transition-all duration-500' />
          <div className='col-span-2 flex justify-center'>
            <img src={img5} alt='Image 5' className='rounded-lg hover:-translate-y-2 transition-all duration-500' />
          </div>
        </div>
